...
{
    public abstract class boiler-plate-core-angularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static boiler-plate-core-angularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(boiler-plate-core-angularWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<boiler-plate-core-angularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<boiler-plate-core-angularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<boiler-plate-core-angularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<boiler-plate-core-angularDbContext, Task<T>> func)
        {
            T result;
