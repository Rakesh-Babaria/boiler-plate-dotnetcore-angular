...
using Shouldly;
using Xunit;
using boiler-plate-core-angular.Sessions;

namespace boiler-plate-core-angular.Tests.Sessions
{
    public class SessionAppService_Tests : boiler-plate-core-angularTestBase
    {
