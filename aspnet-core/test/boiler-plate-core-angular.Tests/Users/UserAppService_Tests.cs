...
using boiler-plate-core-angular.Users;
using boiler-plate-core-angular.Users.Dto;

namespace boiler-plate-core-angular.Tests.Users
{
    public class UserAppService_Tests : boiler-plate-core-angularTestBase
    {
