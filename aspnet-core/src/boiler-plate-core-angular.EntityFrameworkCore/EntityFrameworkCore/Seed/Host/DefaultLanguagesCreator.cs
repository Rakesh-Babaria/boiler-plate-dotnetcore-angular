...
namespace boiler-plate-core-angular.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = boiler-plate-core-angularConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(boiler-plate-core-angularDbContext context)
        {
            _context = context;
        }
